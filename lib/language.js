 ...
    , { code: 'zh_tw', language: '中文（繁體）' }
  ...
  var translations = {
    ...
    ,'%1U reduction needed in active insulin to reach low target, too much basal?' : {
      ...
      ,de: 'Aktives Insulins um %1U reduzieren, um Untergrenze zu erreichen. Basal zu hoch?'
    ...
    ,'basal adjustment out of range, give bolus?' : {
      ...
      ,de: 'Basalrate geht außerhalb des Zielbereiches. Bolus abgeben?'
   ...
   ,'Last Carbs' : {
    ...
    , 'Mean Hourly Change' : {
      ...
      , 'FortyFiveDown': {
          ...
          , cs: 'slightly dropping'
          , de: 'leicht sinkend'
          , dk: 'slightly dropping'
    ...
    'alexaBasal': {
        ...
        , it:  '%1 current basal is %2 units per hour'
    ...
    'alexaBasalTemp': {
        ...
        , it:  '%1 temp basal of %2 units per hour will end %3'
    ...
    'alexaIob': {
        bg: 'and you have %1 insulin on board.'
        , cs: 'and you have %1 insulin on board.'
        , de: 'und du hast %1 Insulin wirkend.'
        , dk: 'and you have %1 insulin on board.'
        ...
        , it: 'and you have %1 insulin on board.'
     ...
     'alexaIobIntent': {
         ...
         , it: 'You have %1 insulin on board'
